...
from TehnoMarket.views import HomePage, Products, Contact, AboutUs, Login, Register, PersonalInfo, SuccessfullyAddedProduct, DetailProductInfo, AddComment, PaymentSuccessful, SelectPaymentMethod, PersonalInfo, Logout, increase_quantity, decrease_quantity, update_profile_image, update_user_info, my_products, add_product, edit_product, delete_product, delete_my_product, add_to_cart_view, view_cart, delete_item_cart, save_order, order_list, update_quantity, approve_product, non_approved_products, product_sent_to_admin, edit_product_image
...
urlpatterns = [
    ...
    path('users/<str:username>/details/update-profile-image/', update_profile_image, name='update_profile_image'),
